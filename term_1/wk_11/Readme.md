Доделать задачу из wk_10.
Исследовать случаи движения под действием негармонической периодической вынуждающей силы:  
1. `F(t) = +A при t<T/2; F(t) = -A при t>T/2`  
2. `F(t) = A*sin(Omega*t) при t<T/2; F(t) = 0 при t>T/2`  
T - период колебаний
